...
public class DateUtilsTest {
    ...
    public void toDate() throws Exception{
        ...
        Date dateInt2Date = DateUtils.DATE_FORMATE_ENUM.FORMATE2yyyyMMdd.toDateSafe(dateInt);
        System.out.println(dateInt2Date);
        int now2Int = DateUtils.DATE_FORMATE_ENUM.FORMATE2yyyyMMdd.toIntSafe(dateInt2Date);
        assertEquals(now2Int,20200329);

        String dateStr = "2020-03-29";
        Date dateStr2Date = DateUtils.DATE_FORMATE_ENUM.FORMATE2yyyy_MM_dd.toDateSafe(dateStr);
        System.out.println(dateStr2Date);
        String now2Str = DateUtils.DATE_FORMATE_ENUM.FORMATE2yyyy_MM_dd.toStringSafe(dateStr2Date);
